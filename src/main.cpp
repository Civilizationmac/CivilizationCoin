...
unsigned int nStakeMinAge = 60 * 60 * 4;	// minimum age for coin age: 4h
unsigned int nStakeMaxAge = -1;	// stake age of full weight: unlimited
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1400491475;
int nCoinbaseMaturity = 220;
...
const string strMessageMagic = "CivilizationCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CivilizationCoin
    bool fStrictPayToScriptHash = true; // Always active in CivilizationCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CivilizationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1400491485;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2129559;
        ...
        assert(block.hashMerkleRoot == uint256("0xd0472af8e736eca2fb657bd73e08db645d88a03c0302ec6d8d2b8805c1550fd5"));
